...
function segment:lessThan(other)
  return self.a:lessThan(other.a) or (self.a:equal(other.a) and self.b:lessThan(other.b))
end
...
function segment:overlap(other)
  ...
  return (selfLeft <= otherRight and selfRight >= otherLeft) and (selfTop <= otherBottom and selfBottom >= otherTop)
end
