...
function quadTreeNode:expand(bounds)
  ...
  if top and left then
    ...
    bottomRight =
      self:_newNode(parent, self:right(), self:bottom(), self:right() + self:width(), self:bottom() + self:height())
  elseif top and right then
    ...
    topRight = self
    bottomLeft =
      self:_newNode(parent, self:left() - self:width(), self:bottom(), self:left(), self:bottom() + self:height())
...
function quadTreeNode:split()
  ...
  local bottomRight =
    self:_newNode(self, self:left() + childWidth, self:top() + childHeight, self:right(), self:bottom())
